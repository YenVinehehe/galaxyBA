...
const defaultHeartImages = Array.from({ length: 48 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  'Chúc BAers thi tốt nha',
  "Điểm cao",
  "Mang điểm 10 về nhé",
  "BA mãi là nhà",
  "Chúc Minh Lộc thi tốt",
  "Chúc Ngọc Nhi thi tốt",
  "Chúc Minh Thư nhỏ thi tốt",
  "Chúc Bảo Quân thi tốt",
  "Chúc Thu Trang thi tốt",
  "Chúc Mỹ Trang thi tốt",
  "Chúc Phúc Hy thi tốt",
  "Chúc Thảo Nguyên (lớn) thi tốt",
  "Chúc Lan Anh thi tốt",
  "Chúc Đại Việt thi tốt",
  "Chúc Thanh Trúc thi tốt",
  "Chúc Kiều Vi thi tốt",
  "Chúc Thuỷ Trương thi tốt",
  "Chúc Xuân Bắc thi tốt",
  "Chúc Bảo Liên thi tốt",
  "Chúc Yến Vi thi tốt",
  "Chúc Quỳnh Tứ thi tốt",
  "Chúc Xuân Hưng thi tốt",
  "Chúc Thanh Trúc thi tốt",
  "Chúc Zăn Đoàn thi tốt",
  "Chúc Đặng Thành thi tốt",
  "Chúc Hoài Phương thi tốt",
  "Chúc Như Hiếu thi tốt",
  "Chúc Thái Bảo thi tốt",
  "Chúc Mỹ Duyên thi tốt",
  "Chúc Mỹ Hoa thi tốt",
  "Chúc Như Thơ thi tốt",
  "Chúc Bích Thuỷ thi tốt",
  "Chúc Xuân Nhi thi tốt",
  "Chúc Minh Tú thi tốt",
  "Chúc Hồng Nhung thi tốt",
  "Chúc Ánh Ngân thi tốt",
  "Chúc Bảo Ngọc thi tốt",
  "Chúc Thuỷ Tiên thi tốt",
  "Chúc Huệ Khánh thi tốt",
  "Chúc Minh Đức thi tốt",
  "Chúc Quốc Việt thi tốt",
  "Chúc Vân Anh thi tốt",
  "Chúc Phương Hà thi tốt",
  "Chúc Hoàng Long thi tốt",
  "Chúc Thanh Ngọc thi tốt",
  "Chúc Thu Hà thi tốt",
  "Chúc Bảo Nhi thi tốt",
  "Chúc Mai Anh thi tốt",
  "Chúc Thanh Tâm thi tốt",
  "Chúc Thảo Nguyên thi tốt",
  "Chúc Trâm Anh thi tốt",
  "Chúc Bảo Thy thi tốt",
  "Chúc Hữu Lộc thi tốt",
  "Chúc Thoại Như thi tốt",
  "Chúc Ngọc Trâm thi tốt",
  "Chúc Yên Chi thi tốt",
  "Chúc Hữu Lợi thi tốt",
  "Chúc Huyền Trân thi tốt",
  "Chúc Khánh Nhung thi tốt",
  "Chúc Cẩm Vân thi tốt",
  "Chúc Nhi Võ thi tốt",
  "Chúc Mỹ Quyên thi tốt",
  "Chúc Khánh Trâm thi tốt",
  "Chúc Hồng Ngoan thi tốt",
  "Chúc Phương Vy thi tốt",
  "Chúc Phương Ngân thi tốt",
  "Chúc Tuyết Nhi thi tốt",
  "Chúc Châu Anh thi tốt",
  "Chúc Thanh Thuỳ thi tốt",
  "Chúc Triệu Duy thi tốt",
  "Chúc Phương Trâm thi tốt",
  "Chúc Thu Huyền thi tốt",
  "Chúc Thanh Thảo (bé) thi tốt",
  "Chúc Thuý An thi tốt",
  "Chúc Thanh Thảo thi tốt",
  "Chúc Mỹ Duyên thi tốt",
